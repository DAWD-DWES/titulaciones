...
class Wsconvocatorias implements RequestInterface
{
    /**
     * @var null | string
     */
     ...
     * @param null | string $pidgrupo
     */
    public function __construct(?string $plengua, ?string $pcurso, ?string $pcodasi, ?string $pidgrupo)
    {
     ...
     * @return static
     */
    public function withPidgrupo(?string $pidgrupo) : static
    {
        $new = clone $this;
        $new->pidgrupo = $pidgrupo;
